...
function ModalPostres() {
    ...
    const datosOtro = DatosMenu.filter(item => item.tipo === 7).map(item => ({ ...item, id: item.id }));
    ...
    return (
        <div >
            <button style={{ backgroundColor: "yellow", paddingTop: '3px' }} className="boton" onClick={abrirModal}>  <FaIceCream /> <br></br>POSTRE</button>
            <Modal isOpen={modalAbierto} onRequestClose={cerrarModal} style={customStyles}>
                <div>
                    <h2>Encabezado del Modal</h2>
