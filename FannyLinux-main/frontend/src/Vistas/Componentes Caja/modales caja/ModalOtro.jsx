...
function ModalOtro() {
    ...
    const datosOtro =DatosMenu.filter(item => item.tipo === 8).map(item => ({ ...item, id: item.id }));
    ...
    return (
        <div >
            <button  style={{ backgroundColor: "yellow", paddingTop: '3px' }} className="boton"   onClick={abrirModal}><FaRegFile /> <br></br>OTRO</button>
